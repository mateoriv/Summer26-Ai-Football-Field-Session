...
def positionDetection(video_path, model_path="yolo_models/positionDetection.pt", output_path="cache/positionDetection/positionDetection.json"):
    """
...
def main():
    ...
    try:
        results = positionDetection(args.video, args.model, args.output)
